...
public class ProgramPagerAdapter extends FragmentPagerAdapter {
    ...
    Exercise exercise;
    Patient patient;
    public ProgramPagerAdapter(Context context, FragmentManager fm, Exercise exercise, Patient patient) {
        super(fm);
        mContext = context;
    ...
    public Fragment getItem(int position) {
        ...
        return PlaceholderFragment.newInstance(position + 1, exercise,patient);
    }
